...
const time = `\n  <!-- ================= TIME ================= -->\n  <section class="stage" data-label="Time" data-screen-label="Time" data-speaker-notes="Somos três: Mário, João Marcos e Jackson. O que nos diferencia é o método: fomos atrás da dor real, a decisão que ninguém assina, com debates estruturados, um Council e verificação adversarial dos nossos próprios números. As escolhas de produto são nossas; a IA foi apoio." style="background:#1F2D22; color:#F3ECDC; padding:90px 120px; display:flex; flex-direction:column; justify-content:center; font-family:'Hanken Grotesk',sans-serif;">\n    <div style="max-width:1560px; margin:0 auto; width:100%;">\n      <p style="font-size:21px; letter-spacing:4px; text-transform:uppercase; color:var(--ga-accent,#D6A23E); font-weight:700; margin:0 0 18px;">Time</p>\n      <h2 style="font-family:'Spectral',serif; font-weight:700; font-size:62px; line-height:1.05; margin:0 0 14px; letter-spacing:-1px;">Somos três. O que muda o jogo é o método.</h2>\n      <p style="font-size:24px; line-height:1.5; color:#F3ECDC; max-width:1100px; margin:0 0 8px; font-weight:600;">Mário Guilberto Machado Souza · João Marcos Cassol · Jackson Meires Dantas Canuto</p>\n      <p style="font-size:19px; line-height:1.5; color:#9FB191; margin:0 0 40px;">Equipe Gabarito · haCARthon 2026 · Desafio 02</p>\n      <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:22px;">\n        <div style="background:#25382A; border:1px solid #2f4733; border-radius:18px; padding:30px 28px;"><p style="font-family:'Spectral',serif; font-size:24px; font-weight:700; color:#F3ECDC; margin:0 0 8px;">Atrás da dor-raiz</p><p style="font-size:18px; line-height:1.45; color:#C7CFB9; margin:0;">A decisão que ninguém assina, achada em debates estruturados e num Council. Não na primeira ideia.</p></div>\n        <div style="background:#25382A; border:1px solid #2f4733; border-radius:18px; padding:30px 28px;"><p style="font-family:'Spectral',serif; font-size:24px; font-weight:700; color:#F3ECDC; margin:0 0 8px;">Brigamos com os números</p><p style="font-size:18px; line-height:1.45; color:#C7CFB9; margin:0;">Verificação adversarial dos próprios dados antes de levar qualquer número ao pitch.</p></div>\n        <div style="background:#25382A; border:1px solid #2f4733; border-radius:18px; padding:30px 28px;"><p style="font-family:'Spectral',serif; font-size:24px; font-weight:700; color:#F3ECDC; margin:0 0 8px;">Aberto e navegável</p><p style="font-size:18px; line-height:1.45; color:#C7CFB9; margin:0;">Protótipo do painel + base em formato aberto, tudo dentro do edital.</p></div>\n      </div>\n      <p style="margin:34px 0 0; font-size:16px; line-height:1.5; color:#7E8E72;">As escolhas de produto e os cortes de escopo são da equipe. A IA foi apoio: pesquisa, verificação dos números, redação e protótipo.</p>\n    </div>\n  </section>\n`;
